  ...
  <body>
    ...
    <div class="fondoservi1">
        ...
        <header>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="text-center"><a href="land.php?idk4=in" style="color: black">Ingles</a></li>
            </ul>
          </li>
        </ul>
        </header>
      ...
      <div class="col-lg-12 text-center">
        ...
        <a name="Servicios"></a>
        <!-- Titulo -->
        <h2 class="titulo1 visible-lg">Services</h2>
        <h2 class="titulo2 hidden-lg">Services</h2>
        <!-- subtitulo -->
        <div class="col-lg-4"></div>
        <div class="col-lg-4"><h4 class="subtitulo1 visible-lg">We offer you a wide range of services</h4></div>
        <div class="col-lg-4"></div>
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    ...
                    <div class="carousel-caption" style="background: rgba(75,54,33,.7);width: 100%; left: 0">
                      <p style="font-size: 35px;"><strong>Pool</strong></p>
                      <a class="btn btn-default btn-lg" data-toggle="modal" data-target="#INST1" style="background: #91c470;" href="#" role="button"><strong>Details</strong></a>
                    </div>
                  </div>
                  <div class="item">
                    <img src="Imagenes/Galeria5.jpg" alt="...">
                    <div class="carousel-caption" style="background: rgba(75,54,33,.7);width: 100%; left: 0">
                      <p style="font-size: 35px;"><strong>Cottages</strong></p>
                      <a class="btn btn-default btn-lg" data-toggle="modal" data-target="#INST2" style="background: #91c470;" href="#" role="button"><strong>Details</strong></a>
                    </div>
                  </div>
                  <div class="item">
                    <img src="Imagenes/Galeria17.jpg" alt="...">
                    <div class="carousel-caption" style="background: rgba(75,54,33,.7);width: 100%; left: 0">
                      <p style="font-size: 35px;"><strong>Furniture</strong></p>
                      <a class="btn btn-default btn-lg" data-toggle="modal" data-target="#INST3" style="background: #91c470;" href="#" role="button"><strong>Details</strong></a>
                    </div>
                  </div>
                  <div class="item">
                    <img src="Imagenes/Galeria9.jpg" alt="...">
                    <div class="carousel-caption" style="background: rgba(75,54,33,.7);width: 100%; left: 0">
                      <p style="font-size: 35px;"><strong>Lake</strong></p>
                      <a class="btn btn-default btn-lg" data-toggle="modal" data-target="#INST4" style="background: #91c470;" href="#" role="button"><strong>Details</strong></a>
                    </div>
                  </div>
                </div>
    ...
    <div class="fondoservi2">
      ...
      <div class="col-lg-12 text-center">
        ...
        <div class="col-lg-4"></div>
        <div class="col-lg-4">
          <h4 class="subtitulo1 visible-lg">Experiences that you can live in our facilities</h4>
        </div>
        <div class="col-lg-4"></div>
      ...
      <div class="col-lg-12 text-center" style="padding-top: 20px;">
        ...
        <div class="col-xs-6 col-md-6 col-lg-3">
          <div class="jumbotron expServicios1">
            ...
            <p><a class="btn btn-lg btnExp" data-toggle="modal" data-target="#Expe1" href="#" role="button"><strong>More</strong></a></p>
          </div>
        </div>
        ...
        <div class="col-xs-6 col-md-6 col-lg-3">
          ...
          <div class="jumbotron expServicios2">
            ...
            <div class="" style="background: rgba(75,54,33,.9);color: #fff">
            <h2><b>Gastronomic</b></h2>
            <h2><b>Experience</b></h2>
            </div>
            <p><a class="btn btn-lg btnExp" data-toggle="modal" data-target="#Expe2" href="#" role="button"><strong>More</strong></a></p>
          </div>
        </div>
        ...
        <div class="col-xs-6 col-md-6 col-lg-3">
          <div class="jumbotron expServicios3">
            ...
            <p><a class="btn btn-lg btnExp" data-toggle="modal" data-target="#Expe3" href="#" role="button"><strong>More</strong></a></p>
          </div>  
        </div>
        ...
        <div class="col-xs-6 col-md-6 col-lg-3">
         <div class="jumbotron expServicios4">
            ...
            <p><a class="btn btn-lg btnExp" data-toggle="modal" data-target="#Expe4" href="#" role="button"><strong>More</strong></a></p>
          </div>
        </div>
          ...
          <div class="col-xs-6 col-md-6 col-lg-4">
            ...
            <table class="table" style="font-size: 20px; color: #fff">
              ...
              <tbody>
                  <tr>
                    <!-- Nosostros -->
                    <td style="text-align: center;"><a href="NosotrosIng.php" style="font-family: 'Nunito', sans-serif; color: #fff">About
     ...
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.9);">
        <div class="modal-header">
           ...
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Pool</strong></h4>
        </div>
        <div class="modal-body text-center">
          <img src="Imagenes/Galeria16.jpg" class="img-responsive" alt="Responsive image">  
          <h3 style="color: white"><strong>Description</strong></h3>
        ...
        <div class="modal-footer" style="text-align: center;">
          ...
          <button type="button" class="btn" data-dismiss="modal" style="background-color: #4c7338ff; color: white">Close</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="INST2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.9);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Cottage</strong></h4>
        </div>
        <div class="modal-body text-center">
  ...
  <div class="modal fade" id="INST3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.9);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>furniture</strong></h4>
        </div>
        <div class="modal-body text-center">
  ...
  <div class="modal fade" id="INST4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.9);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Lake</strong></h4>
        </div>
        <div class="modal-body text-center">
  ...
  <div class="modal fade" id="Expe1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.8);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Family Experience</strong></h4>
        </div>
        <div class="modal-body text-center">
  ...
  <div class="modal fade" id="Expe2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.8);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Gastronomic Experience</strong></h4>
        </div>
        <div class="modal-body text-center">
  ...
  <div class="modal fade" id="Expe3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.8);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Romantic Experience</strong></h4>
        </div>
        <div class="modal-body text-center">
  ...
  <div class="modal fade" id="Expe4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(25,25,25,.8);">
        <div class="modal-header">
           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <h4 class="modal-title text-center" id="myModalLabel" style="color: #fff; font-size: 40px; font-family: font-family: 'Roboto Condensed', sans-serif;"><strong>Adventure Experience</strong></h4>
        </div>
        <div class="modal-body text-center">
